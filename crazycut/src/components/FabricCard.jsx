  ...
  return (
    <div className="group block" aria-label={`${fabric.color} ${fabric.name} ${fabric.weave_type} fabric`}>
      <div className="relative aspect-[4/5] overflow-hidden bg-muted">
        ...
        <div className="pointer-events-none absolute bottom-0 inset-x-0 p-4 flex items-end justify-between opacity-0 group-hover:opacity-100 transition-opacity duration-500">
